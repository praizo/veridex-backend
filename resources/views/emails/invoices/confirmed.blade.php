...
<head>
    ...
    <title>Invoice confirmed by Veridex</title>
</head>
                ...
                <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="width: 560px; max-width: calc(100% - 32px); background-color: #ffffff; border-radius: 10px; border: 1px solid #dbe3f1; box-shadow: 0 12px 30px rgba(10, 29, 67, 0.10); overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h1 style="color: #0a1d43; font-size: 22px; line-height: 1.3; margin: 0 0 12px;">Invoice confirmed</h1>
                            ...
                            <p style="color: #475569; font-size: 15px; line-height: 1.6; margin: 0 0 24px;">
                                Your tax-compliant invoice <strong style="color: #0a1d43;">#{{ $invoiceNumber }}</strong> has been processed and confirmed by the National Revenue Service (NRS).
                            </p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #f0f4fb; border: 1px solid #c8d6f0; border-radius: 10px; margin: 0 0 26px;">
                                <tr>
                                    <td style="padding: 20px;">
                                        <div style="color: #64748b; font-size: 12px; font-weight: 700; letter-spacing: 1.2px; margin-bottom: 12px; text-transform: uppercase;">Invoice details</div>
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="color: #64748b; font-size: 14px; padding: 6px 0;">Amount due</td>
                                                <td align="right" style="color: #0a1d43; font-size: 14px; font-weight: 700; padding: 6px 0;">{{ $currency }} {{ number_format($amount, 2) }}</td>
                                            </tr>
                                            <tr>
                                                <td style="color: #64748b; font-size: 14px; padding: 6px 0;">Status</td>
                                                <td align="right" style="color: #0a1d43; font-size: 14px; font-weight: 700; padding: 6px 0;">Confirmed &amp; transmitted</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <p style="color: #64748b; font-size: 14px; line-height: 1.5; margin: 0 0 24px;">
                                The official A4 PDF version of your invoice is attached. It includes the IRN and QR code for verification.
                            </p>

                            <table role="presentation" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="background-color: #0a1d43; border-radius: 8px;">
                                        <a href="{{ config('app.frontend_url', config('app.url')) }}" style="display: inline-block; padding: 12px 18px; color: #ffffff; font-size: 14px; font-weight: 700; text-decoration: none;">View in dashboard</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
