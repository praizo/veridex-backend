...
<head>
    ...
    <title>Reset your Veridex password</title>
</head>
                ...
                <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="width: 560px; max-width: calc(100% - 32px); background-color: #ffffff; border-radius: 10px; border: 1px solid #dbe3f1; box-shadow: 0 12px 30px rgba(10, 29, 67, 0.10); overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h1 style="color: #0a1d43; font-size: 22px; line-height: 1.3; margin: 0 0 12px;">Reset your password</h1>

                            <p style="color: #475569; font-size: 15px; line-height: 1.6; margin: 0 0 24px;">
                                Use the secure link below to choose a new password for your Veridex account.
                            </p>

                            <table role="presentation" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="background-color: #0a1d43; border-radius: 8px;">
                                        <a href="{{ $actionUrl }}" style="display: inline-block; padding: 12px 18px; color: #ffffff; font-size: 14px; font-weight: 700; text-decoration: none;">Reset Password</a>
                                    </td>
                                </tr>
                            </table>

                            <p style="color: #64748b; font-size: 14px; line-height: 1.5; margin: 24px 0 8px;">
