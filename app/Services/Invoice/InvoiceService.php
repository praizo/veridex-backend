...
class InvoiceService
{
     ...
     */
    public function createInvoice(CreateInvoiceDTO $dto, ?User $actor = null): Invoice
    {
     ...
     */
    public function updateDraftInvoice(Invoice $invoice, CreateInvoiceDTO $dto, ?User $actor = null): Invoice
    {
        ...
        return DB::transaction(function () use ($invoice, $dto, $actor) {
            $calculated = $this->calculateAuthoritativeAmounts($dto);
